        ...
        <div className="form">
            ...
            <form onSubmit = { save } name="cardDetail">
                <label className="form__label">Name of Card
                    <input className="input form__name" type="text" name="name" defaultValue={cards[activeCardId].cardName} autoComplete="off" />
                </label>
                <label className="form__label">Card Number
                    <input className="input form__number" type="text" name="number" defaultValue={cards[activeCardId].cardNumber} autoComplete="off" />
                </label>
                <div className="form__line">
                    <label className="form__label">Expiry Date
                        <input className="input form__expiry" type="text" name="expiry" defaultValue={cards[activeCardId].cardExpiry} autoComplete="off" />
                    </label>
...
function mapDispatchToProps(dispatch ) {
    return {
        save: (e) => {
            ...
            dispatch(saveCard({activeCardId:0, cards: cards}))
        },
    }
}
